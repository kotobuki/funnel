...
/*
  Mofidied for Arduino Fio by Shigeru Kobayashi and Jeff Hoefs

  Changes are:
  * Set the baud rate depend on the boards's model
    - 57600bps for Arduino Fio (ATmega328P)
    - 19200bps for FIO (was Funnel IO, ATmega168V)
  * Send information of digital pins each time to make sure, 
    since packets might be lost
*/
...
void outputPort(byte portNumber, byte portValue, boolean forceSend)
{
...
void loop() 
{
  ...
  if (currentMillis - previousMillis > samplingInterval) {
    ...
    /* DIGITALREAD - do check digital inputs at the configured sampling interval */
    /* with force update option enabled */
