...
\vskip -\lastskip \vskip -3pt
\caption{A typical screenshot of XBeeConfigTool}
\label{default}
\end{center}
\end{figure}
...
\item Copy \texttt{funnel\_009/libraries/processing/library/} as \texttt{My Documents/Processing/libraries/funnel/library/} (on Windows) or \texttt{Documents/Processing/libraries/funnel/library/} (on Mac OS X).
\item Copy \texttt{libraries/processing/sketch\_samples/} into the document folder.
\item Launch Processing to confirm that `funnel' is displayed as a menu item of Sketch/Import Library... menu. If you can't see, please confirm about the previous step.
\end{enumerate}
